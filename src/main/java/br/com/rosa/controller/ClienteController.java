...
public class ClienteController {
	...
	@PostMapping
	@Transactional
	public ResponseEntity<DataClient> registerClient(@RequestBody ClientRegister dados, UriComponentsBuilder uriBuilder) {
	...
	@DeleteMapping("{id}")
	@Transactional
	public ResponseEntity<Page<DadosItem>> deleteClient(@PathVariable Long id) {
		service.deleteId(id);
